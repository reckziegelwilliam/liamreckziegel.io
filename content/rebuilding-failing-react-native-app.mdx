...
subtitle: 'From 12% Crash Rate to Production-Ready in 3 Months'
slug: 'rebuilding-failing-react-native-app'
publishedAt: '2024-12-09'
summary: 'Taking over a crashing React Native app and delivering a stable production build in 3 months. Debugging strategies, architectural rewrites, and prioritization.'
tags: 'react-native, debugging, architecture, mobile, performance'
type: 'Playbook'
---
...
<MetricsGrid metrics={[
  { value: '12%', label: 'Crash Rate (Before)' },
  { value: '0.8%', label: 'Crash Rate (After)' },
  { value: '3 months', label: 'Rebuild Time' },
...
<Alert type="warning">
Don't attempt a full rewrite in one go. Incremental improvements while maintaining stability is the safer approach. Fix critical paths first, then systematically address technical debt.
</Alert>
...
<Comparison 
  labels={{ before: 'Props Drilling Chaos', after: 'Redux Toolkit' }}
  before={
    <>
      <p><strong>Inconsistent state updates:</strong></p>
      <ul>
        <li>Props drilled 5+ levels deep</li>
        <li>Multiple sources of truth</li>
        <li>Race conditions everywhere</li>
